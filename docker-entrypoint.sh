...
if [ "$ENV" = "DEV" ]; then
	...
	exec node api_gateway/server.js -p 5001 | ./node_modules/.bin/bunyan --color -o short
	...
	exec node api_gateway/server.js -p 5002 | ./node_modules/.bin/bunyan --color -o short
